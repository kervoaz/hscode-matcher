...
key-files:
  created:
    - hscode-matcher-api/src/main/java/com/zou/hs/matcher/ingestion/GoodsCodes.java
    - hscode-matcher-api/src/main/java/com/zou/hs/matcher/ingestion/NomenclatureRegistryBuilder.java
    - hscode-matcher-api/src/main/java/com/zou/hs/matcher/ingestion/NomenclatureRegistry.java
    - hscode-matcher-api/src/main/java/com/zou/hs/matcher/ingestion/NomenclatureIntegrityValidator.java
    - hscode-matcher-api/src/main/java/com/zou/hs/matcher/ingestion/NomenclatureIngestException.java
    - hscode-matcher-api/src/main/java/com/zou/hs/matcher/ingestion/RawNomenclatureRow.java
    - hscode-matcher-api/src/main/java/com/zou/hs/matcher/ingestion/csv/CsvNomenclatureReader.java
    - hscode-matcher-api/src/main/java/com/zou/hs/matcher/ingestion/csv/NomenclatureCsvFormat.java
    - hscode-matcher-api/src/main/java/com/zou/hs/matcher/ingestion/xlsx/XlsxNomenclatureExporter.java
    - hscode-matcher-api/src/main/java/com/zou/hs/matcher/ingestion/export/ExportNomenclatureCsv.java
    - hscode-matcher-api/src/test/java/com/zou/hs/matcher/ingestion/GoodsCodesTest.java
    - hscode-matcher-api/src/test/java/com/zou/hs/matcher/ingestion/NomenclatureRegistryBuilderTest.java
    - hscode-matcher-api/src/test/java/com/zou/hs/matcher/ingestion/NomenclatureEuFilesIT.java
  modified:
