...
files_modified:
  ...
  - hscode-matcher-api/src/main/java/com/zou/hs/matcher/search/lucene/IndexBuilder.java
  - hscode-matcher-api/src/main/java/com/zou/hs/matcher/search/lucene/NomenclatureIndex.java
  - hscode-matcher-api/src/main/java/com/zou/hs/matcher/search/lucene/LuceneSearcher.java
  - hscode-matcher-api/src/main/java/com/zou/hs/matcher/search/lucene/AnalyzerFactory.java
  - hscode-matcher-api/src/main/java/com/zou/hs/matcher/search/model/ScoredHit.java
  - hscode-matcher-api/src/test/java/com/zou/hs/matcher/search/lucene/IndexBuilderTest.java
  - hscode-matcher-api/src/test/java/com/zou/hs/matcher/search/lucene/LuceneSearcherFuzzyTest.java
autonomous: true
requirements:
  - R2
  - R8
...
must_haves:
  ...
  artifacts:
    - path: "hscode-matcher-api/src/main/java/com/zou/hs/matcher/search/lucene/IndexBuilder.java"
    ...
    - path: "hscode-matcher-api/src/main/java/com/zou/hs/matcher/search/lucene/NomenclatureIndex.java"
    ...
    - path: "hscode-matcher-api/src/main/java/com/zou/hs/matcher/search/lucene/LuceneSearcher.java"
    ...
    - path: "hscode-matcher-api/src/main/java/com/zou/hs/matcher/search/lucene/AnalyzerFactory.java"
      provides: "Map<Language, Analyzer> with FrenchAnalyzer, EnglishAnalyzer, GermanAnalyzer"
    - path: "hscode-matcher-api/src/main/java/com/zou/hs/matcher/search/model/ScoredHit.java"
...
<task type="auto" tdd="true">
  ...
  <action>
    ...
    **ScoredHit** (package `com.zou.hs.matcher.search.model`):
    ```java
    public record ScoredHit(String hsCode, float score) {}
    ```

    **AnalyzerFactory** (package `com.zou.hs.matcher.search.lucene`):
    ...
    **IndexBuilder** (package `com.zou.hs.matcher.search.lucene`):
    ...
    **IndexBuilderTest** (package `com.zou.hs.matcher.search.lucene`):
  ...
  <verify>
    <automated>cd /c/Users/zou/dev/ZOU/HSCODE/hscode-matcher-api && rtk ./mvnw test -pl . -Dtest=IndexBuilderTest -q 2>&1 | tail -20</automated>
  </verify>
  <done>
...
<task type="auto" tdd="true">
  ...
  <action>
    **NomenclatureIndex** (package `com.zou.hs.matcher.search.lucene`):
    ```java
    ...
    **LuceneSearcher** (package `com.zou.hs.matcher.search.lucene`):
    ...
    **LuceneSearcherFuzzyTest** (package `com.zou.hs.matcher.search.lucene`):
  ...
  <verify>
    <automated>cd /c/Users/zou/dev/ZOU/HSCODE/hscode-matcher-api && rtk ./mvnw test -pl . -Dtest="IndexBuilderTest,LuceneSearcherFuzzyTest" -q 2>&1 | tail -20</automated>
  </verify>
  <done>
