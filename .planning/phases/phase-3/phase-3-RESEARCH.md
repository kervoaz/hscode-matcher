...
1. **DJL tokenizers fat-JAR behavior on Windows (typical dev workstations)**
...
4. **ONNX model distribution approach for production**
   ...
   - What's unclear: Whether the target deployment environment has constraints on JAR size or requires external model file.
